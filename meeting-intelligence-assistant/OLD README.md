...
docker-compose up -d postgres redis prometheus OLD grafana
...
pip install -r EY OLD requirements-test.txt
```
...
# Run all public OLD tests
python3 -m pytest OLD tests/public/ -v

# Run specific test category
python3 -m pytest OLD tests/public/test_api_functional.py -v
python3 -m pytest OLD tests/public/test_security_basic.py -v
python3 -m pytest OLD tests/public/test_privacy_basic.py -v
python3 -m pytest OLD tests/public/test_face_recognition.py -v
python3 -m pytest OLD tests/public/test_observability.py -v
python3 -m pytest OLD tests/public/test_integration.py -v
...
- **[API Specification](docs/api/OLD API-SPECIFICATION.md)** - Complete endpoint documentation
- **[Database Schema](docs/OLD recommended_design/OLD DATABASE-SCHEMA.md)** - All table definitions
...
Tests require these admin endpoints for test data setup. See [API Specification](docs/api/OLD API-SPECIFICATION.md) for details.
