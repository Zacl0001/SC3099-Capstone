...
def http_client():
    ...
    This client persists across all OLD tests in a session for efficiency.
    """
...
def client(http_client):
    """Alias for http_client for backward compatibility with existing OLD tests."""
    return http_client
...
def synthetic_face_base64() -> str:
    """Provide a synthetic uniform face image for anti-spoofing OLD tests."""
...
def face_test_data() -> Dict[str, str]:
    """
    Fixture providing test images for face recognition OLD tests.
...
def attack_test_data() -> Dict[str, str]:
    """
    Fixture providing attack images for anti-spoofing OLD tests.
...
# =============================================================================
# Bulk User Creation Fixture (for stress OLD tests)
# =============================================================================
