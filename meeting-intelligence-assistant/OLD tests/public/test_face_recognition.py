...
These OLD tests verify the face recognition microservice functionality:
...
Students can run these OLD tests locally to validate their implementation.
...
def create_synthetic_face_base64(width=256, height=256):
    """Create uniform skin-tone image for anti-spoofing OLD tests."""
...
class TestFaceMatching:
    ...
    def enrolled_hash(self, face_client):
        """Enroll a face using real face image and return the hash for matching OLD tests."""
        # Use a real face image for enrollment
        real_face_image = get_real_face_image_base64()
